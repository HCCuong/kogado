<div class="slide-header section fp-section active" data-fb-styles="null">
...
<?php if (!empty($about)) { ?>
	<div class="wrap-about section" data-fb-styles="null">
		<div class="fp-overflow" tabindex="-1">
...
<?php if (!empty($themanh)) { ?>
	<div class="wrap-themanh section fp-section fp-table fp-is-overflow" data-fb-styles="null">
		<div class="fp-overflow" tabindex="-1">
			<div class="box-1">
				<div class="slide-themanh1">
					<?php foreach ($themanh as $v) { ?>
						<div class="themanh1">
							<div class="themanh-bg">
								<?= $func->getImage(['class' => 'w-100', 'sizes' => '1366x720x1', 'upload' => UPLOAD_NEWS_L, 'image' => $v['photo'], 'alt' => $v['name' . $lang]]) ?>
							</div>
							<div class="themanh-content">
			...
			<div class="box-2">
				<div class="div-box-2">
					<div class="slide-themanh2">
						<?php foreach ($themanh as $v) { ?>
							<div class="themanh2">
								<?= $func->getImage(['class' => 'w-100', 'sizes' => '280x360x1', 'upload' => UPLOAD_NEWS_L, 'image' => $v['photo'], 'alt' => $v['name' . $lang]]) ?>
							</div>
						<?php } ?>
					</div>
...
<?php if (!empty($news)) { ?>
	<div class="wrap-news section fp-section" data-fb-styles="null">
		<div class="fp-overflow" tabindex="-1">
			<div class="wrap-content">
				<div class="title-main">
...
<div class="footer-article footer_index section" data-fb-styles="null">
	<div class="fp-overflow" tabindex="-1">
		<div class="footer">
			<div class="wrap-content">
				<div class="row">
