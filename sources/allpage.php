...
$fanpage = $cache->get("select id, photo, link from #_photo where type = ? limit 0,1", array('fanpage'), 'fetch', 7200);
...
$vechungtoi = $cache->get("select name$lang, desc$lang, content$lang, photo from #_news where type = ? and find_in_set('hienthi',status) order by numb,id desc limit 0,1", array('ve-chung-toi'), 'fetch', 7200);
