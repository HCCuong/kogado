...
function savePhotoStatic()
{
    ...
    if ($id) {
        ...
        if ((!empty($config['photo']['photo_static'][$type]['videofile']) && $func->hasFile("file")) || (!empty($config['photo']['photo_static'][$type]['images']) && $func->hasFile("file")) || (isset($data['link_video']) && $data['link_video'] != '')) {
