    ...
    <form class="validation-form" novalidate method="post" id="form-watermark" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <?php } else if (isset($config['photo']['photo_static'][$type]['videofile']) && $config['photo']['photo_static'][$type]['videofile'] == true) { ?>
                    <div class="form-group">
                        <label class="change-photo" for="file">
                            <p>Upload video:</p>
                            <div class="rounded">
                                <video id="myVideo" loop muted data-autoplay style="max-width:300px;">
                                    <source src="../<?= UPLOAD_PHOTO_L . $item['photo'] ?>" type="video/mp4">
                                </video>
                                <strong>
